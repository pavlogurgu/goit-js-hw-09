...
function onStart() {
    ...
    (0, _notiflixDefault.default).Loading.hourglass("In progress", {
        backgroundColor: "transparent",
        cssAnimationDuration: 500
    });
    (0, _notiflixDefault.default).Loading.remove(3000);
    ...
    intervalId = setInterval(()=>{
        ...
        if (dataDays.textContent == "00" && dataHours.textContent == "00" && dataMinutes.textContent == "00" && dataSeconds.textContent == "00") (0, _notiflixDefault.default).Notify.success("Ding-Dong");
    }, 1000);
}
const options = {
    enableTime: true,
    ...
    onClose (selectedDates) {
        if (selectedDates[0] <= Date.now()) {
            ...
            (0, _notiflixDefault.default).Notify.info("Your timer is ready to run");
        }
    }
};
...
},{"flatpickr":"llQu5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","flatpickr/dist/flatpickr.min.css":"eVN6V","notiflix":"5WWYd"}],"llQu5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
